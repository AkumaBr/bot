...
module.exports = kconfig = async (kill, message) => {
    ...
    try {
        ...
        case 'sticker':;case 'fig':;case 'figurinha':;case 's':;case 'f':;case 's':
        ...
        case 'stickergif':;case 'gif':;case 'st':;case 'gifsticker':
